 ...
 *
 * If applied to a field, marks that field as trackable.  If applied to a class, marks all fields as
 * trackable except for those explicitly annotated with {@link NotTracked}.
 */
